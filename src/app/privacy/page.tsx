      ...
      <main className="flex-1 container max-w-3xl px-4 py-16">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-8 text-sm leading-relaxed text-foreground">
          <Section title="1. Introduction">
            <p>
              Welcome to Orcazo ("we", "us", or "our"). We are committed to
          ...
          <Section title="2. Information We Collect">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Payment information necessary to process payouts (bank or crypto
                details)
              </li>
            ...
            <p>
              ...
              as IP address, browser type, and usage data when you use our
              platform.
            </p>
          </Section>
          ...
          <Section title="4. Sharing Your Information">
            <p>
              ...
              our platform (e.g. payment processors, email services, hosting
              providers), subject to confidentiality agreements.
            </p>
            <p>
              We may also disclose your information if required by law or to
              protect the rights, property, or safety of Orcazo, our users, or
              others.
            </p>
          </Section>
          ...
          <Section title="6. Security">
            <p>
              ...
              measures to protect your information against unauthorised access,
          ...
          <Section title="7. Your Rights">
            ...
            <p>
              ...
              <a href="mailto:hello@orcazo.com" className="underline">
                hello@orcazo.com
              </a>
              .
            </p>
          ...
          <Section title="8. Cookies">
            <p>
              We use session cookies strictly necessary for platform
              functionality (authentication). We do not use advertising or
          ...
          <Section title="9. Changes to This Policy">
            <p>
              ...
              page with an updated date. Your continued use of the platform
