...
const schema = z.object({
  ...
  })).min(1, 'At least one social account is required').max(4),
  // Honeypot
...
export function CreatorSignupDialog({
  ...
  const mutation = useMutation({
    mutationFn: (values: Form) =>
      api.post<{ ok: true }>('/api/public/creator-signup', { ...values, turnstileToken }),
    onSuccess: () => {
      setSubmitted(true);
    },
    onError: (err: unknown) => toast.error((err as Error)?.message || 'Could not submit application'),
  });
        ...
        {submitted ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground max-w-sm mx-auto">
              ...
              WhatsApp within 24 hours with the next steps.
            </p>
            <Button className="mt-6" onClick={() => onOpenChange(false)}>Got it</Button>
          </div>
        ) : (
          <>
            <DialogHeader>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="space-y-2">
                  ...
                  <Input id="fullName" placeholder="Jane Doe" disabled={mutation.isPending} {...form.register('fullName')} />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="publicEmail" type="email" placeholder="you@email.com" disabled={mutation.isPending} {...form.register('publicEmail')} />
              ...
              <div className="space-y-2">
                ...
                <Input id="whatsapp" placeholder="+1 555 123 4567" disabled={mutation.isPending} {...form.register('whatsapp')} />
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  At least 1 required. 3–4 accounts strongly preferred — they help us approve faster.
                </p>
                <div className="space-y-2">
                  {fields.map((field, i) => (
                ...
                {form.formState.errors.socialAccounts && typeof form.formState.errors.socialAccounts.message === 'string' && (
                  <p className="text-xs text-destructive">{form.formState.errors.socialAccounts.message}</p>
                )}
              </div>
