      ...
      <div className="container max-w-7xl px-4 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="text-muted-foreground mt-3 max-w-xs leading-relaxed">
            The supreme platform for organic content marketing. Connect brands with vetted creators worldwide.
          </p>
        </div>
        <div>
          <div className="font-semibold mb-3">Platform</div>
          <ul className="space-y-2 text-muted-foreground">
            <li><Link href="/" className="hover:text-foreground">For Brands</Link></li>
            <li><Link href="/creators" className="hover:text-foreground">For Creators</Link></li>
